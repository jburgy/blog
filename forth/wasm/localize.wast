...
(module
    ...
    (func $/mod (param $cfa i32) (param $ip i32) (param $sp i32) (param $rsp i32)
        (local $a i32)
        (local $b i32)
        (local.set $a (i32.load offset=4 (local.get $sp)))
        (local.set $b (i32.load offset=0 (local.get $sp)))
        (i32.store offset=4 (local.get $sp) (i32.rem_s (local.get $a) (local.get $b)))
        (i32.store offset=0 (local.get $sp) (i32.div_s (local.get $a) (local.get $b)))
        (return_call $next (local.get $cfa) (local.get $ip) (local.get $sp) (local.get $rsp))
    )
