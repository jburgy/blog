...
(module
    ...
    (data (i32.const 0x5328) "\14\53\00\00\02>R\00\37\00\00\00")
    (func $>r (type 0)
    ...
    (data (i32.const 0x5334) "\28\53\00\00\02R>\00\38\00\00\00")
    (func $r> (type 0)
    ...
    (data (i32.const 0x5340) "\34\53\00\00\04RSP@\00\00\00\39\00\00\00")
    (func $rsp@ (type 0)
    ...
    (data (i32.const 0x5350) "\40\53\00\00\04RSP!\00\00\00\3a\00\00\00")
    (func $rsp! (type 0)
    ...
    (data (i32.const 0x5360) "\50\53\00\00\05RDROP\00\00\3b\00\00\00")
    (func $rdrop (type 0)
        (global.set $rsp (i32.add (global.get $rsp) (i32.const 4)))
        (return_call $next)
    )
    ...
    (data (i32.const 0x5370) "\60\53\00\00\04DSP@\00\00\00\3c\00\00\00")
    (func $dsp@ (type 0)
    ...
    (data (i32.const 0x5380) "\70\53\00\00\04DSP!\00\00\00\3d\00\00\00")
    (func $dsp! (type 0)
    ...
    (data (i32.const 0x5390) "\80\53\00\00\03KEY\3e\00\00\00")
    (func $key (type 0)
        (call $push (call $_key))
        (return_call $next)
    )
    ...
    (data (i32.const 0x53bc) "\ac\53\00\00\06NUMBER\00\41\00\00\00")
    (func $number (type 0)
    ...
    (data (i32.const 0x53cc) "\bc\53\00\00\04FIND\00\00\00\42\00\00\00")
    (func $find (type 0)
    ...
    (data (i32.const 0x53dc) "\cc\53\00\00\04>CFA\00\00\00\43\00\00\00")
    (func $>cfa (type 0)
    ...
    (data (i32.const 0x5408) "\ec\53\00\00\06CREATE\00\44\00\00\00")
    (func $create (type 0)
    ...
    (data (i32.const 0x5430) "\24\54\00\00\01]\00\00\47\00\00\00")
    (func $rbrac (type 0)
    ...
    (data (i32.const 0x543c) "\30\54\00\00\89IMMEDIATE\00\00\48\00\00\00")
