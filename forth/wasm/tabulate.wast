...
(module
    ...
    (func $forth (export "_start")
        ...
        (loop $next
            ...
            ;; -rot
            (i32.store offset=0 (local.get $sp) (local.get 4))
            ...
            ;; 2dup
            (i32.store (local.tee $sp (i32.sub (local.get $sp) (i32.const 8))) (i32.load offset=8 (local.get $sp)))
            (i32.store (local.tee $sp (i32.sub (local.get $sp) (i32.const 4))) (i32.load offset=4 (local.get $sp)))
            (br $next))
            ...
            ;; hidden
            (i32.store8 offset=4 (local.tee 0 (i32.load (local.get $sp))) (i32.xor (i32.load8_u offset=4 (local.get 0)) (global.get $f_hidden)))
            (local.set $sp (i32.add (local.get $sp) (i32.const 4)))
            (br $next))
            ...
            (if (i32.load (local.get $sp))
                ...
                (else
                    (local.set $sp (i32.add (local.get $sp) (i32.const 4)))
                    (local.set $cfa (i32.const 0x5620)) ;; cfa of branch
                    (br $dispatch)
                )
            ))
    ...
    (data (i32.const 0x5054) "\44\50\00\00\04SWAP\00\00\00\01\00\00\00")
    (data (i32.const 0x5064) "\54\50\00\00\03DUP\01\00\00\00")
    (data (i32.const 0x5070) "\64\50\00\00\04OVER\00\00\00\01\00\00\00")
    (data (i32.const 0x5080) "\70\50\00\00\03ROT\01\00\00\00")
    (data (i32.const 0x508c) "\80\50\00\00\04-ROT\00\00\00\01\00\00\00")
    (data (i32.const 0x509c) "\8c\50\00\00\052DROP\00\00\01\00\00\00")
    (data (i32.const 0x50ac) "\9c\50\00\00\042DUP\00\00\00\01\00\00\00")
    (data (i32.const 0x50bc) "\ac\50\00\00\052SWAP\00\00\01\00\00\00")
    (data (i32.const 0x50cc) "\bc\50\00\00\04?DUP\00\00\00\01\00\00\00")
    (data (i32.const 0x50dc) "\cc\50\00\00\021+\00\01\00\00\00")
    (data (i32.const 0x50e8) "\dc\50\00\00\021-\00\01\00\00\00")
    (data (i32.const 0x50f4) "\e8\50\00\00\024+\00\01\00\00\00")
    (data (i32.const 0x5100) "\f4\50\00\00\024-\00\01\00\00\00")
    (data (i32.const 0x510c) "\00\51\00\00\01+\00\00\01\00\00\00")
    (data (i32.const 0x5118) "\0c\51\00\00\01-\00\00\01\00\00\00")
    (data (i32.const 0x5124) "\18\51\00\00\01*\00\00\01\00\00\00")
    (data (i32.const 0x5130) "\24\51\00\00\04/MOD\00\00\00\01\00\00\00")
    (data (i32.const 0x5140) "\30\51\00\00\01=\00\00\01\00\00\00")
    (data (i32.const 0x514c) "\40\51\00\00\02<>\00\01\00\00\00")
    (data (i32.const 0x5158) "\4c\51\00\00\01<\00\00\01\00\00\00")
    (data (i32.const 0x5164) "\58\51\00\00\01>\00\00\01\00\00\00")
    (data (i32.const 0x5170) "\64\51\00\00\02<=\00\01\00\00\00")
    (data (i32.const 0x517c) "\70\51\00\00\02>=\00\01\00\00\00")
    (data (i32.const 0x5188) "\7c\51\00\00\020=\00\01\00\00\00")
    (data (i32.const 0x5194) "\88\51\00\00\030<>\01\00\00\00")
    (data (i32.const 0x51a0) "\94\51\00\00\020<\00\01\00\00\00")
    (data (i32.const 0x51ac) "\a0\51\00\00\020>\00\01\00\00\00")
    (data (i32.const 0x51b8) "\ac\51\00\00\030<=\01\00\00\00")
    (data (i32.const 0x51c4) "\b8\51\00\00\030>=\01\00\00\00")
    (data (i32.const 0x51d0) "\c4\51\00\00\03AND\01\00\00\00")
    (data (i32.const 0x51dc) "\d0\51\00\00\02OR\00\01\00\00\00")
    (data (i32.const 0x51e8) "\dc\51\00\00\03XOR\01\00\00\00")
    (data (i32.const 0x51f4) "\e8\51\00\00\06INVERT\00\01\00\00\00")
    (data (i32.const 0x5204) "\f4\51\00\00\04EXIT\00\00\00\01\00\00\00")
    (data (i32.const 0x5214) "\04\52\00\00\03LIT\01\00\00\00")
    (data (i32.const 0x5220) "\14\52\00\00\01!\00\00\01\00\00\00")
    (data (i32.const 0x522c) "\20\52\00\00\01@\00\00\01\00\00\00")
    (data (i32.const 0x5238) "\2c\52\00\00\02+!\00\01\00\00\00")
    (data (i32.const 0x5244) "\38\52\00\00\02-!\00\01\00\00\00")
    (data (i32.const 0x5250) "\44\52\00\00\02C!\00\01\00\00\00")
    (data (i32.const 0x525c) "\50\52\00\00\02C@\00\01\00\00\00")
    (data (i32.const 0x5268) "\5c\52\00\00\04C@C!\00\00\00\01\00\00\00")
    (data (i32.const 0x5278) "\68\52\00\00\05CMOVE\00\00\01\00\00\00")
    (data (i32.const 0x5288) "\78\52\00\00\05STATE\00\00\01\00\00\00")
    (data (i32.const 0x5298) "\88\52\00\00\04HERE\00\00\00\01\00\00\00")
    (data (i32.const 0x52a8) "\98\52\00\00\06LATEST\00\01\00\00\00")
    (data (i32.const 0x52b8) "\a8\52\00\00\02S0\00\01\00\00\00")
    (data (i32.const 0x52c4) "\b8\52\00\00\04BASE\00\00\00\01\00\00\00")
    (data (i32.const 0x52d4) "\c4\52\00\00\07VERSION\01\00\00\00")
    (data (i32.const 0x52e4) "\d4\52\00\00\02R0\00\01\00\00\00")
    (data (i32.const 0x52f0) "\e4\52\00\00\05DOCOL\00\00\01\00\00\00")
    (data (i32.const 0x5300) "\f0\52\00\00\07F_IMMED\01\00\00\00")
    (data (i32.const 0x5310) "\00\53\00\00\08F_HIDDEN\00\00\00\01\00\00\00")
    (data (i32.const 0x5324) "\10\53\00\00\09F_LENMASK\00\00\01\00\00\00")
    (data (i32.const 0x5338) "\24\53\00\00\08SYS_EXIT\00\00\00\01\00\00\00")
    (data (i32.const 0x534c) "\38\53\00\00\08SYS_OPEN\00\00\00\01\00\00\00")
    (data (i32.const 0x5360) "\4c\53\00\00\09SYS_CLOSE\00\00\01\00\00\00")
    (data (i32.const 0x5374) "\60\53\00\00\08SYS_READ\00\00\00\01\00\00\00")
    (data (i32.const 0x5388) "\74\53\00\00\09SYS_WRITE\00\00\01\00\00\00")
    (data (i32.const 0x539c) "\88\53\00\00\09SYS_CREAT\00\00\01\00\00\00")
    (data (i32.const 0x53b0) "\9c\53\00\00\07SYS_BRK\01\00\00\00")
    (data (i32.const 0x53c0) "\b0\53\00\00\08O_RDONLY\00\00\00\01\00\00\00")
    (data (i32.const 0x53d4) "\c0\53\00\00\08O_WRONLY\00\00\00\01\00\00\00")
    (data (i32.const 0x53e8) "\d4\53\00\00\06O_RDWR\00\01\00\00\00")
    (data (i32.const 0x53f8) "\e8\53\00\00\07O_CREAT\01\00\00\00")
    (data (i32.const 0x5408) "\f8\53\00\00\06O_EXCL\00\01\00\00\00")
    (data (i32.const 0x5418) "\08\54\00\00\07O_TRUNC\01\00\00\00")
    (data (i32.const 0x5428) "\18\54\00\00\08O_APPEND\00\00\00\01\00\00\00")
    (data (i32.const 0x543c) "\28\54\00\00\0aO_NONBLOCK\00\01\00\00\00")
    (data (i32.const 0x5450) "\3c\54\00\00\02>R\00\01\00\00\00")
    (data (i32.const 0x545c) "\50\54\00\00\02R>\00\01\00\00\00")
    (data (i32.const 0x5468) "\5c\54\00\00\04RSP@\00\00\00\01\00\00\00")
    (data (i32.const 0x5478) "\68\54\00\00\04RSP!\00\00\00\01\00\00\00")
    (data (i32.const 0x5488) "\78\54\00\00\05RDROP\00\00\01\00\00\00")
    (data (i32.const 0x5498) "\88\54\00\00\04DSP@\00\00\00\01\00\00\00")
    (data (i32.const 0x54a8) "\98\54\00\00\04DSP!\00\00\00\01\00\00\00")
    (data (i32.const 0x54b8) "\a8\54\00\00\03KEY\01\00\00\00")
    (data (i32.const 0x54c4) "\b8\54\00\00\04EMIT\00\00\00\01\00\00\00")
    (data (i32.const 0x54d4) "\c4\54\00\00\04WORD\00\00\00\01\00\00\00")
    (data (i32.const 0x54e4) "\d4\54\00\00\06NUMBER\00\01\00\00\00")
    (data (i32.const 0x54f4) "\e4\54\00\00\04FIND\00\00\00\01\00\00\00")
    (data (i32.const 0x5504) "\f4\54\00\00\04>CFA\00\00\00\01\00\00\00")
    (data (i32.const 0x5514) "\04\55\00\00\04>DFA\00\00\00\00\00\00\00\10\55\00\00\fc\50\00\00\10\52\00\00")
    (data (i32.const 0x5530) "\14\55\00\00\06CREATE\00\01\00\00\00")
    (data (i32.const 0x5540) "\30\55\00\00\01,\00\00\01\00\00\00")
    (data (i32.const 0x554c) "\40\55\00\00\81[\00\00\01\00\00\00")
    (data (i32.const 0x5558) "\4c\55\00\00\01]\00\00\01\00\00\00")
    (data (i32.const 0x5564) "\58\55\00\00\89IMMEDIATE\00\00\01\00\00\00")
    (data (i32.const 0x5578) "\64\55\00\00\06HIDDEN\00\01\00\00\00")
    ...
    (data (i32.const 0x5608) "\dc\55\00\00\01'\00\00\01\00\00\00")
    (data (i32.const 0x5614) "\08\56\00\00\06BRANCH\00\01\00\00\00")
    (data (i32.const 0x5624) "\14\56\00\00\070BRANCH\01\00\00\00")
    (data (i32.const 0x5634) "\24\56\00\00\09LITSTRING\00\00\01\00\00\00")
    (data (i32.const 0x5648) "\34\56\00\00\04TELL\00\00\00\01\00\00\00")
    (data (i32.const 0x5658) "\48\56\00\00\09INTERPRET\00\00\01\00\00\00")
    ...
    (data (i32.const 0x56a0) "\7c\56\00\00\04CHAR\00\00\00\01\00\00\00")
    (data (i32.const 0x56b0) "\a0\56\00\00\07EXECUTE\01\00\00\00")
    (data (i32.const 0x56c0) "\b0\56\00\00\08SYSCALL3\00\00\00\01\00\00\00")
    (data (i32.const 0x56d4) "\c0\56\00\00\08SYSCALL2\00\00\00\01\00\00\00")
    (data (i32.const 0x56e8) "\d4\56\00\00\08SYSCALL1\00\00\00\01\00\00\00")
)